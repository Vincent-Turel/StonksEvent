...
//        );
//
//        activityManager.createActivity(LocalDateTime.of(2022, 1, 1, 18, 0, 0), Duration.ofMinutes(120), "Discours de M. Papazian (1)", "Le directeur du département informatique fera ses adieux à ses fans (1)", 20, event1.getId());
//        activityManager.createActivity(LocalDateTime.of(2022, 1, 1, 20, 0, 0), Duration.ofMinutes(120), "Discours de M. Papazian (2)", "Le directeur du département informatique fera ses adieux à ses fanss (4)", 20, event1.getId());
//    }
//
//    @Test
